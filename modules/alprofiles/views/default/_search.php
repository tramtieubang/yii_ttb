...
<div class="al-profiles-form-search">
	...
	<div class="row">
<div class="col-md-4">    <?= $form->field($model, 'system_id')->textInput() ?>
...
</div><div class="col-md-4">    <?= $form->field($model, 'door_types')->textInput(['maxlength' => true]) ?>

</div><div class="col-md-4">    <?= $form->field($model, 'length')->textInput() ?>

</div><div class="col-md-4">    <?= $form->field($model, 'weight_per_meter')->textInput(['maxlength' => true]) ?>

</div><div class="col-md-4">    <?= $form->field($model, 'unit_price')->textInput(['maxlength' => true]) ?>

</div><div class="col-md-4">    <?= $form->field($model, 'image_url')->textInput(['maxlength' => true]) ?>

</div><div class="col-md-4">    <?= $form->field($model, 'note')->textarea(['rows' => 6]) ?>

</div><div class="col-md-4">    <?= $form->field($model, 'status')->textInput(['maxlength' => true]) ?>
