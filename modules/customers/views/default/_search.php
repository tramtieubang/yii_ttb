...
<div class="customers-form-search">
...
</div><div class="col-md-4">    <?= $form->field($model, 'address')->textInput(['maxlength' => true]) ?>

</div><div class="col-md-4">    <?= $form->field($model, 'note')->textInput(['maxlength' => true]) ?>
