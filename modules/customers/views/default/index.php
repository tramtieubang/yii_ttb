...
/* @var $searchModel app\modules\customers\models\CustomersSearch */
...
<div class="customers-form-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    .
                    Html::a('<i class="fa-solid fa-circle-plus me-2" aria-hiddi="true"></i> Thêm từ excel', ['/customers/import-excel/view'],
                        [
                            'role'=>'modal-remote',
                            'title'=> 'Import Excel',
                            'class'=>'dropdown-item',
