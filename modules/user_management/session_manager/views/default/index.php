...
/* @var $searchModel app\modules\user_management\session_manager\models\UserSessionsSearch */
...
<div class="user-sessions-form-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'pjax'=>true,
            'responsiveWrap' => false, // Quan trọng!
