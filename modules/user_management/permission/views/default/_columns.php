...
return [
    ...
    [
        ...
        'value' => function ($model) {
            return $model->groupCode ? $model->groupCode->name : null;
        },
    ],
    [
        'class' => 'kartik\grid\ActionColumn',
        ...
        'buttons' => [
            'phanquyen' => function ($url, $model) {
                return Html::a(
                    '<i class="fa fa-link me-1"></i> Chức năng',
                    ['/user_management/permission/permission-route', 'id' => $model->name],
                    [
                        'title' => 'Routes của quyền',
