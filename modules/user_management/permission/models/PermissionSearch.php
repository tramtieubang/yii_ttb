...
/**
 * PermissionSearch represents the model behind the search form about `app\modules\permission\models\PermissionForm`.
 */
class PermissionSearch extends PermissionForm
{
    ...
    public function search($params, $cusomSearch=NULL)
    {
        ...
        if ($cusomSearch != NULL) {
            $query->andWhere(['type' => 2]); // ✅ thêm điều kiện tại đây
