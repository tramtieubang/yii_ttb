...
class RolePermissionController extends Controller
{
    ...
    public function actionIndex($id)
    {
        ...
        return $this->asJson([
            ...
            'success' => true,
            'content' => $this->renderAjax('/role-permission/role-permission', [
                'user_role' => $user_role, // Truyền model sang view
            ...
            'footer' =>
                ...
                Html::button('Lưu lại', [
                    ...
                    'type' => 'submit', 
                    'id' => 'btn-save-user-permission'
                ]),
        ]); 
    }

    public function actionSavePermissions($id)
    {
        $request = Yii::$app->request;

        // Lấy danh sách quyền được chọn từ form
        $permissions = $request->post('permissions', []); // mảng tên quyền hoặc []
        ...
        try {
            ...
            foreach ($permissions as $child) {
                ...
                $model->save(false);    // bỏ validate nếu dữ liệu đảm bảo
            }
