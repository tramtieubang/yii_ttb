        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    Html::a(
                        '<i class="fa-solid fa-circle-plus me-2" aria-hidden="true"></i> Têm từ excel', 
                        ['/products/import-excel/view'],
                        [
                            //'role' => 'modal-remote-bulk',  // button xóa
                            'title' => 'Thêm sản phẩm từ excel',
                            'class' => 'btn btn-outline-primary',
                            //'class' => 'btn btn-outline-danger', // mau do xoa
                            'role' => 'modal-remote-2', // nếu bạn dùng modal AJAX thay doi tham so 'modal-remote-2' show modal thứ 2
                            'data-pjax' => 0,
            ...
            'panel' => [
                ...
                'before'=>'<em>* Danh sách sản phẩm</em>',
