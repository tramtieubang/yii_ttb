...
/**
 * DefaultController implements the CRUD actions for ProductsForm model.
 */
class DefaultController extends Controller
{
    ...
    {    
        $searchModel = new ProductsSearch();
  		if(isset($_POST['search']) && $_POST['search'] != null){
            ...
            $searchModel = new ProductsSearch(); // "reset"
    ...
    /**
     * Displays a single ProductsForm model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new ProductsForm model.
    ...
    /**
     * Updates an existing ProductsForm model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing ProductsForm model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing ProductsForm model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the ProductsForm model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return ProductsForm the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = ProductsForm::findOne($id)) !== null) {
            return $model;
        } else {
