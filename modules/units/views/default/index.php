...
/* @var $searchModel app\modules\units\models\UnitsSearch */
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    .
                    Html::a('<i class="fa-solid fa-circle-plus me-2" aria-hiddi="true"></i> Thêm từ excel', ['/units/import-excel/view'],
                        [
                            'role'=>'modal-remote',
                            'title'=> 'Import Excel',
                            'class'=>'dropdown-item',
