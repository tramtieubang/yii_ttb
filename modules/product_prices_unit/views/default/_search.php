...
<div class="product-prices-unit-form-search">
	...
	<div class="row">
<div class="col-md-4">    <?= $form->field($model, 'product_id')->textInput() ?>

</div><div class="col-md-4">    <?= $form->field($model, 'unit_id')->textInput() ?>
